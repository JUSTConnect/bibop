...
func _check_mouse_selection_commands() -> void:
	...
	_expect(commands.size() == 28, "mouse selection command count changed")
	...
	var marker: Dictionary = commands[27]
...
func _check_interaction_commands() -> void:
	...
	_expect_line(commands[0], Vector2(70.96, 52.04), Vector2(84.4208, 52.04), Color(0.02, 0.05, 0.07, 0.4878), 4.65, true, "corner 0 horizontal shadow")
	_expect_line(commands[1], Vector2(70.96, 52.04), Vector2(70.96, 65.5008), Color(0.02, 0.05, 0.07, 0.4878), 4.65, true, "corner 0 vertical shadow")
	_expect_line(commands[2], Vector2(70.96, 52.04), Vector2(84.4208, 52.04), Color(0.2, 0.9, 1.0, 0.6775), 2.65, true, "corner 0 horizontal color")
	_expect_line(commands[3], Vector2(70.96, 52.04), Vector2(70.96, 65.5008), Color(0.2, 0.9, 1.0, 0.6775), 2.65, true, "corner 0 vertical color")
	_expect_line(commands[4], Vector2(129.04, 52.04), Vector2(115.5792, 52.04), Color(0.02, 0.05, 0.07, 0.4878), 4.65, true, "corner 1 horizontal shadow")
	_expect_line(commands[5], Vector2(129.04, 52.04), Vector2(129.04, 65.5008), Color(0.02, 0.05, 0.07, 0.4878), 4.65, true, "corner 1 vertical shadow")
	_expect_line(commands[8], Vector2(129.04, 107.96), Vector2(115.5792, 107.96), Color(0.02, 0.05, 0.07, 0.4878), 4.65, true, "corner 2 direction")
	_expect_line(commands[12], Vector2(70.96, 107.96), Vector2(84.4208, 107.96), Color(0.02, 0.05, 0.07, 0.4878), 4.65, true, "corner 3 direction")
