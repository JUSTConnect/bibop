...
checks = [
    ...
    ("reel service does not create bindings", "create_binding(" not in service),
    ("BindingStore rejects runtime feed role", '"runtime_power_feed"' in binding and "PHYSICAL_RELATION_ROLES" in binding),
