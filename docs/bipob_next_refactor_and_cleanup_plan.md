...
Статус: targeting service extraction, action view-model service extraction, capability service extraction, PR-X2 runtime action actor builder extraction, PR-X3 terminal control execution helper extraction, PR-X4 Heavy Claw execution helper extraction и PR-X5 generic world-object execution helper extraction завершены; полный BipobController split ещё не завершён. `BipobController` остаётся coordinator/executor; item pickup execution ещё НЕ вынесен.
