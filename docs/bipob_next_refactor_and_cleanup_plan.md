...
- [x] вынести Map Constructor screen/root orchestration без inspector/property/link controls;
...
- [x] вынести PR-V5 Map Constructor save/load readiness validation boundary без изменения persistence execution;
...
Статус: targeting service extraction, action view-model service extraction, capability service extraction, PR-X2 runtime action actor builder extraction, PR-X3 terminal control execution helper extraction, PR-X4 Heavy Claw execution helper extraction, PR-X5 generic world-object execution helper extraction и PR-X6 item pickup execution helper extraction завершены; полный BipobController split ещё не завершён. `BipobController` остаётся coordinator/executor; legacy tile interactions и legacy scan/hack/open_door helpers ещё не вынесены.
...
- [x] вынести PR-X3 terminal control execution helper;
- [x] вынести PR-X4 Heavy Claw execution helper;
- [x] вынести PR-X5 generic world-object execution helper;
- [x] вынести PR-X6 item pickup execution helper;
