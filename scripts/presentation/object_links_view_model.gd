...
static func create(links_schema: Array, data: Dictionary = {}, entity_kind: String = "world_object", entity_id: String = "", link_targets: Array = []) -> Dictionary:
	...
	var warnings: Array[String] = ObjectLinkSystemRef.validate_links(links, links_schema, entity_id, link_targets)
...
static func _control_type_for_link_type(link_type: String) -> String:
	match link_type:
		"object_ref", "object_ref_array": return "enum"
		_: return "line_edit"

static func _make_options(link_id: String, link_type: String, entity_id: String, link_targets: Array) -> Array[String]:
...
static func _default_value_for_link_type(link_type: String) -> Variant:
	return [] if link_type == "object_ref_array" else ""
