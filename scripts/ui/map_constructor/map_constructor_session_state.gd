...
const SESSION_PROPERTY_NAMES: Array[StringName] = [
	&"map_constructor_inspector_expanded",
	...
	&"map_constructor_preset_name",
	&"map_constructor_preset_entries",
	&"map_constructor_selected_preset_name",
	&"map_constructor_patch_name",
	&"map_constructor_patch_entries",
	&"map_constructor_selected_patch_name",
	&"map_constructor_geometry_width_text",
	&"map_constructor_geometry_height_text",
	&"map_constructor_marker_mode",
	&"map_constructor_prefab_search_text",
	&"map_constructor_prefab_category_filter",
	&"map_constructor_prefab_role_filter",
	&"map_constructor_prefab_placement_filter",
	&"map_constructor_prefab_show_diagnostics",
	&"map_constructor_prefab_show_expected_invalid",
	&"map_constructor_prefab_show_only_placeable_here",
	&"map_constructor_prefab_favorites",
	&"map_constructor_prefab_recent_ids",
	&"map_constructor_placed_search_text",
	&"map_constructor_issue_filter",
	&"map_constructor_selected_issue_id",
	&"map_constructor_cleanup_preview",
	&"map_constructor_cleanup_pending_apply_key",
	&"map_constructor_autofix_preview",
	&"map_constructor_autofix_pending_apply_key",
	&"map_constructor_new_power_network_id",
	&"map_constructor_patch_json_text",
	&"map_constructor_patch_preview",
	&"map_constructor_patch_parsed",
	&"map_constructor_patch_pending_apply",
	&"map_constructor_change_history_filter",
	&"map_constructor_multi_selected_entities",
	&"map_constructor_batch_preview",
	&"map_constructor_batch_pending_apply_operation",
	&"map_constructor_batch_pending_apply_key",
	&"map_constructor_batch_offset_x",
	&"map_constructor_batch_offset_y",
	&"map_constructor_batch_power_network_id",
	&"map_constructor_selected_kit_id",
	&"map_constructor_selected_template_id",
	&"map_constructor_template_rotation",
	&"map_constructor_template_mirror_x",
	&"map_constructor_template_mirror_y",
	...
	&"map_constructor_kit_preview_can_apply",
	&"map_constructor_template_preview_can_apply",
	&"map_constructor_design_notes_text",
	&"selected_room_visual_preset_id",
	&"room_visual_preset_preview",
	...
	&"map_constructor_overview_show_items",
	&"map_constructor_overview_show_wall_mounted",
	&"map_constructor_overview_show_history",
]
...
func has_session_property(property_name: StringName) -> bool:
	return SESSION_PROPERTY_NAMES.has(property_name)
