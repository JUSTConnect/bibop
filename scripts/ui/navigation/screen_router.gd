...
const SCREEN_BOX_CONSTRUCTOR: StringName = &"box_constructor"
const SCREEN_MISSION_CONSTRUCTOR: StringName = &"mission_constructor"
const SCREEN_MISSION_RESULT: StringName = &"mission_result"
const SCREEN_PLACEHOLDER: StringName = &"placeholder"
const SCREEN_CHARGING: StringName = &"charging"
const SCREEN_REPAIR: StringName = &"repair"
const SCREEN_PROGRAMMER: StringName = &"programmer"
