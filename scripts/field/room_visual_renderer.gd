...
<<<<<<< HEAD
const WALL_MOUNT_SIDE_OFFSET_SE := Vector2(16.0, 0.0)
const WALL_MOUNT_SIDE_SHARED_Y_OFFSET := -3.0
const WALL_MOUNTED_COMMON_X_OFFSET := 8.0
const WALL_MOUNTED_DEVICE_HEIGHT_OFFSET := -22.0
const WALL_MOUNTED_LIGHT_HEIGHT_OFFSET := -38.0
=======
...
>>>>>>> 037301b37b4aae17c2f56f4aa6e30e8f084334a8
