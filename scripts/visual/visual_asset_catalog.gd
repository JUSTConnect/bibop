...
const ASSET_PATHS: Dictionary = {
	...
	"external_air_duct": "res://assets/visual/isometric/cooling system/air_duct_wall.png",
	"air_duct": "res://assets/visual/isometric/cooling system/air_duct_wall.png",
	"air_duct_wall": "res://assets/visual/isometric/cooling system/air_duct_wall.png",
	"external_water_pipe": "res://assets/visual/isometric/cooling system/water_pipe_wall.png",
	"water_pipe": "res://assets/visual/isometric/cooling system/water_pipe_wall.png",
	"water_pipe_wall": "res://assets/visual/isometric/cooling system/water_pipe_wall.png",
	...
	"air_cooling_off_floor_sw_01": "res://assets/visual/isometric/objects/cooling/air_cooling_off_floor_SW.png",
	"air_cooling_on_floor_ne_01": "res://assets/visual/isometric/objects/cooling/air_cooling_on_floor_NE.png",
	"air_cooling_on_floor_sw_01": "res://assets/visual/isometric/objects/cooling/air_cooling_on_floor_SW.png",
	"pulsar_overlay_air_cooling_off_floor_ne_01": "res://assets/visual/isometric/objects/cooling/pulsar_overlay_air_cooling_off_floor_NE.png",
	"pulsar_overlay_air_cooling_off_floor_sw_01": "res://assets/visual/isometric/objects/cooling/pulsar_overlay_air_cooling_off_floor_SW.png",
	"pulsar_overlay_air_cooling_on_floor_ne_01": "res://assets/visual/isometric/objects/cooling/pulsar_overlay_air_cooling_on_floor_NE.png",
	"pulsar_overlay_air_cooling_on_floor_sw_01": "res://assets/visual/isometric/objects/cooling/pulsar_overlay_air_cooling_on_floor_SW.png",
...
const OBJECT_ASSET_ALIASES: Dictionary = {
	...
	"parts": "parts_floor_01",
	"details": "parts_floor_01",
	"detail": "parts_floor_01",
	"ditales": "parts_floor_01",
	"currency_parts": "parts_floor_01",
	"parts_small": "parts_floor_01",
	"parts_medium": "parts_floor_01",
	"parts_large": "parts_floor_01",
	"fuse": "fuse_floor_01",
	"reinforcement": "reinforcement_floor_01",
	"reinforce": "reinforcement_floor_01",
	"rebar": "reinforcement_floor_01",
	...
	"external_air_duct": "air_duct_inner_wall_01",
	"air_duct": "air_duct_inner_wall_01",
	"air_duct_wall": "air_duct_inner_wall_01",
	"external_water_pipe": "water_pipe_inner_wall_01",
	"water_pipe": "water_pipe_inner_wall_01",
	"water_pipe_wall": "water_pipe_inner_wall_01",
	...
	"air_cooling": "air_cooling_base_floor_sw_01",
	"air_cooler": "air_cooling_base_floor_sw_01",
	"cooling_fan": "air_cooling_base_floor_sw_01",
	"air_cooling_sw": "air_cooling_base_floor_sw_01",
	"air_cooling_se": "air_cooling_base_floor_sw_01",
	"air_cooling_ne": "air_cooling_base_floor_ne_01",
	"air_cooling_nw": "air_cooling_base_floor_ne_01",
	"air_cooling_base_sw": "air_cooling_base_floor_sw_01",
	"air_cooling_base_se": "air_cooling_base_floor_sw_01",
	"air_cooling_base_ne": "air_cooling_base_floor_ne_01",
	"air_cooling_base_nw": "air_cooling_base_floor_ne_01",
	"air_cooling_off_sw": "air_cooling_off_floor_sw_01",
	"air_cooling_off_se": "air_cooling_off_floor_sw_01",
	"air_cooling_off_ne": "air_cooling_off_floor_ne_01",
	"air_cooling_off_nw": "air_cooling_off_floor_ne_01",
	"air_cooling_on_sw": "air_cooling_on_floor_sw_01",
	"air_cooling_on_se": "air_cooling_on_floor_sw_01",
	"air_cooling_on_ne": "air_cooling_on_floor_ne_01",
	"air_cooling_on_nw": "air_cooling_on_floor_ne_01",
	...
	"steel_box": "heavy_crate_floor_01",
...
const VISUAL_STATE_ASSET_FAMILIES: Dictionary = {
	...
	"air_cooling": {
		...
		"default_variant": "sw",
		"valid_variants": ["ne", "nw", "se", "sw"],
		"direction_variants": {
			"sw": {"source": "sw", "mirror_x": false},
			"se": {"source": "sw", "mirror_x": true},
			"ne": {"source": "ne", "mirror_x": false},
			"nw": {"source": "ne", "mirror_x": true}
		},
		"states": {
			"sw": {"base": "air_cooling_base_floor_sw_01", "off": "air_cooling_off_floor_sw_01", "on": "air_cooling_on_floor_sw_01"},
			"ne": {"base": "air_cooling_base_floor_ne_01", "off": "air_cooling_off_floor_ne_01", "on": "air_cooling_on_floor_ne_01"}
		},
		"overlays": {
			"sw": {"off": ["pulsar_overlay_air_cooling_off_floor_sw_01"], "on": ["pulsar_overlay_air_cooling_on_floor_sw_01"]},
...
const CANONICAL_OBJECT_VISUAL_IDS: Array[String] = [
	...
	"air_cooling_off_floor_sw_01",
	"air_cooling_on_floor_ne_01",
	"air_cooling_on_floor_sw_01",
	"pulsar_overlay_air_cooling_off_floor_ne_01",
	"pulsar_overlay_air_cooling_off_floor_sw_01",
	"pulsar_overlay_air_cooling_on_floor_ne_01",
...
static func get_floor_material_presentation(canonical_material_id: String) -> Dictionary:
