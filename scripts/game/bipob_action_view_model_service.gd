...
static func _runtime_action_requires_free_manipulator(action_id: String, target_object: Dictionary) -> bool:
	...
	return action_id in ["open", "close", "unlock", "switch", "force_open", "push", "pull", "insert_fuse", "remove_fuse", "repair", "cut", "impact", "break_breachable_wall", "take_end_1", "take_end_2", "plug_in", "plug_out", "connect_wire_end", "connect_wire_1", "connect_wire_2", "disconnect_power_wire", "disconnect_wire_1", "disconnect_wire_2"]
