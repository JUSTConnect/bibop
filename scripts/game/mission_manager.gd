...
func _get_map_constructor_prefab_metadata_catalog() -> Dictionary:
	var metadata: Dictionary = {
		...
		"cable_reel": {"display_name":"Cable Reel","category":"Objects","subcategory":"Prop","placement_mode":"object","system_roles":["prop"],"tags":["cable","reel","object"],"description":"Floor cable reel prop.","placement_hint":"Place on a floor cell.","requires_wall":false,"requires_floor":true,"is_destructive":false,"is_diagnostic":false,"is_expected_invalid_tool":false,"can_have_power_network":false,"can_have_links":false,"default_state":{}},
		...
		"power_cable_reel": {"display_name":"Power Cable Reel","category":"Utility","subcategory":"Power Utility","placement_mode":"wall_mounted","system_roles":["power_network"],"tags":["power","cable","reel","wall","utility"],"description":"Wall-mounted cable utility node.","placement_hint":"Requires a valid adjacent wall side.","requires_wall":true,"requires_floor":true,"is_destructive":false,"is_diagnostic":false,"is_expected_invalid_tool":false,"can_have_power_network":true,"can_have_links":false,"default_state":{}},
	}
	return metadata
