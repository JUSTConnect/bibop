...
func _get_map_constructor_prefab_metadata_catalog() -> Dictionary:
	var metadata: Dictionary = {
		...
		"external_air_duct": {"display_name":"External Air Duct","category":"Cooling","subcategory":"Wall-mounted","placement_mode":"wall_mounted","system_roles":["cooling","airflow"],"tags":["air","duct","wall"],"description":"Wall-mounted external air duct.","placement_hint":"Requires a wall cell.","requires_wall":true,"requires_floor":false,"is_destructive":false,"is_diagnostic":false,"is_expected_invalid_tool":false,"can_have_power_network":false,"can_have_links":false,"default_state":{"wall_routing_mode":"outer"}},
		"external_water_pipe": {"display_name":"External Water Pipe","category":"Cooling","subcategory":"Wall-mounted","placement_mode":"wall_mounted","system_roles":["cooling","water"],"tags":["water","pipe","wall"],"description":"Wall-mounted external water pipe.","placement_hint":"Requires a wall cell.","requires_wall":true,"requires_floor":false,"is_destructive":false,"is_diagnostic":false,"is_expected_invalid_tool":false,"can_have_power_network":false,"can_have_links":false,"default_state":{"wall_routing_mode":"outer"}},
