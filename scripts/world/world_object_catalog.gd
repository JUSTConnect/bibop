...
const ARCHETYPE_REGISTRY: Dictionary = {
	...
	"external_wall": {
		"entity_contract":{"scope":"excluded", "exclusion_reason":"structural_surface"},
	...
	"door": {
		"entity_contract":{"scope":"entity", "entity_type":"object", "entity_subtype":"door", "status_profile":"object_standard", "property_profile":"definition_schema", "interaction_profile":"standard_object", "notification_profile":"standard_action", "power_profile":"configurable", "control_profile":"configurable", "access_profile":"standard", "binding_profile":"standard", "runtime_presentation_profile":"standard_object", "editor_presentation_profile":"standard_object", "validation_fixture":"default", "capabilities":{"state":true, "power":true, "health":true, "energy":false, "overheat":false, "control":true, "access":true, "bindings":true, "mount":false, "side":true, "routing":false, "test_override":true}},
	...
	"platform": {
		"entity_contract":{"scope":"entity", "entity_type":"object", "entity_subtype":"platform", "status_profile":"object_standard", "property_profile":"definition_schema", "interaction_profile":"standard_object", "notification_profile":"standard_action", "power_profile":"configurable", "control_profile":"configurable", "access_profile":"none", "binding_profile":"none", "runtime_presentation_profile":"standard_object", "editor_presentation_profile":"standard_object", "validation_fixture":"default", "capabilities":{"state":true, "power":true, "health":true, "energy":false, "overheat":false, "control":true, "access":false, "bindings":false, "mount":false, "side":false, "routing":false, "test_override":true}},
	...
	"terminal": {
		"entity_contract":{"scope":"entity", "entity_type":"object", "entity_subtype":"terminal", "status_profile":"object_standard", "property_profile":"definition_schema", "interaction_profile":"standard_object", "notification_profile":"standard_action", "power_profile":"configurable", "control_profile":"configurable", "access_profile":"standard", "binding_profile":"standard", "runtime_presentation_profile":"standard_object", "editor_presentation_profile":"standard_object", "validation_fixture":"default", "capabilities":{"state":true, "power":true, "health":true, "energy":false, "overheat":false, "control":true, "access":true, "bindings":true, "mount":false, "side":true, "routing":false, "test_override":true}},
	...
	"bipob": {
		"entity_contract":{"scope":"excluded", "exclusion_reason":"actor"},
	...
	"station": {
		"entity_contract":{"scope":"entity", "entity_type":"object", "entity_subtype":"station", "status_profile":"object_standard", "property_profile":"definition_schema", "interaction_profile":"standard_object", "notification_profile":"standard_action", "power_profile":"configurable", "control_profile":"configurable", "access_profile":"none", "binding_profile":"standard", "runtime_presentation_profile":"standard_object", "editor_presentation_profile":"standard_object", "validation_fixture":"default", "capabilities":{"state":true, "power":true, "health":true, "energy":false, "overheat":false, "control":true, "access":false, "bindings":true, "mount":false, "side":false, "routing":false, "test_override":true}},
	...
	"firewall": {
		"entity_contract":{"scope":"entity", "entity_type":"object", "entity_subtype":"firewall", "status_profile":"object_standard", "property_profile":"definition_schema", "interaction_profile":"standard_object", "notification_profile":"standard_action", "power_profile":"configurable", "control_profile":"configurable", "access_profile":"none", "binding_profile":"standard", "runtime_presentation_profile":"standard_object", "editor_presentation_profile":"standard_object", "validation_fixture":"default", "capabilities":{"state":true, "power":true, "health":true, "energy":false, "overheat":false, "control":true, "access":false, "bindings":true, "mount":true, "side":true, "routing":false, "test_override":true}},
	...
	"digital_item": {
		"entity_contract":{"scope":"entity", "entity_type":"item", "entity_subtype":"digital_item", "status_profile":"item_standard", "property_profile":"definition_schema", "interaction_profile":"item", "notification_profile":"standard_action", "power_profile":"none", "control_profile":"none", "access_profile":"none", "binding_profile":"standard", "runtime_presentation_profile":"standard_item", "editor_presentation_profile":"standard_item", "validation_fixture":"default", "capabilities":{"state":true, "power":false, "health":false, "energy":false, "overheat":false, "control":false, "access":false, "bindings":true, "mount":true, "side":false, "routing":false, "test_override":true}},
	...
	"access_item": {
		"entity_contract":{"scope":"entity", "entity_type":"item", "entity_subtype":"access_item", "status_profile":"item_standard", "property_profile":"definition_schema", "interaction_profile":"item", "notification_profile":"standard_action", "power_profile":"none", "control_profile":"none", "access_profile":"standard", "binding_profile":"standard", "runtime_presentation_profile":"standard_item", "editor_presentation_profile":"standard_item", "validation_fixture":"default", "capabilities":{"state":true, "power":false, "health":false, "energy":false, "overheat":false, "control":false, "access":true, "bindings":true, "mount":true, "side":false, "routing":false, "test_override":true}},
	...
	"light_switcher": {
		"entity_contract":{"scope":"entity", "entity_type":"object", "entity_subtype":"light_switcher", "status_profile":"object_standard", "property_profile":"definition_schema", "interaction_profile":"standard_object", "notification_profile":"standard_action", "power_profile":"configurable", "control_profile":"configurable", "access_profile":"none", "binding_profile":"standard", "runtime_presentation_profile":"standard_object", "editor_presentation_profile":"standard_object", "validation_fixture":"default", "capabilities":{"state":true, "power":true, "health":true, "energy":false, "overheat":false, "control":true, "access":false, "bindings":true, "mount":true, "side":true, "routing":false, "test_override":true}},
	...
	"radiator": {
		"entity_contract":{"scope":"entity", "entity_type":"cooling_system", "entity_subtype":"radiator", "status_profile":"cooling_passive", "property_profile":"fixed", "interaction_profile":"cooling", "notification_profile":"none", "power_profile":"none", "control_profile":"none", "access_profile":"none", "binding_profile":"none", "runtime_presentation_profile":"standard_cooling", "editor_presentation_profile":"standard_cooling", "validation_fixture":"default", "capabilities":{"state":false, "power":false, "health":false, "energy":false, "overheat":false, "control":false, "access":false, "bindings":false, "mount":false, "side":false, "routing":false, "test_override":true}},
		"archetype_id":"radiator", "object_group":"cooling", "object_type":"radiator", "palette_label":"Radiator",
		"placement_mode":"object", "placement_surfaces":["floor"], "default_placement_surface":"floor", "requires_floor_anchor_when_wall_mounted":false, "display_name_template":"Radiator", "configurable":false, "cooling_device_type":"radiator", "cooling_output":1, "movement_requirement":{"profile_id":"noncrate_heavy_drag","required_actor_types":["engineer","heavy"],"required_manipulator":"heavy_claw","required_manipulator_level":1,"required_power_class":"engineer","movement_mode":"drag"}, "blocks_movement":true, "property_schema":[]
	},
	"light": {
		"entity_contract":{"scope":"entity", "entity_type":"light", "entity_subtype":"light", "status_profile":"light_standard", "property_profile":"definition_schema", "interaction_profile":"light", "notification_profile":"standard_action", "power_profile":"configurable", "control_profile":"configurable", "access_profile":"none", "binding_profile":"standard", "runtime_presentation_profile":"standard_light", "editor_presentation_profile":"standard_light", "validation_fixture":"default", "capabilities":{"state":true, "power":true, "health":false, "energy":false, "overheat":false, "control":true, "access":false, "bindings":true, "mount":true, "side":true, "routing":false, "test_override":true}},
	...
	"repair_kit": {
		"entity_contract":{"scope":"entity", "entity_type":"item", "entity_subtype":"repair_kit", "status_profile":"item_standard", "property_profile":"fixed", "interaction_profile":"item", "notification_profile":"standard_action", "power_profile":"none", "control_profile":"none", "access_profile":"none", "binding_profile":"none", "runtime_presentation_profile":"standard_item", "editor_presentation_profile":"standard_item", "validation_fixture":"default", "capabilities":{"state":true, "power":false, "health":false, "energy":false, "overheat":false, "control":false, "access":false, "bindings":false, "mount":true, "side":false, "routing":false, "test_override":true}},
	...
	"reinforcement": {
		"entity_contract":{"scope":"entity", "entity_type":"item", "entity_subtype":"reinforcement", "status_profile":"item_standard", "property_profile":"fixed", "interaction_profile":"item", "notification_profile":"standard_action", "power_profile":"none", "control_profile":"none", "access_profile":"none", "binding_profile":"none", "runtime_presentation_profile":"standard_item", "editor_presentation_profile":"standard_item", "validation_fixture":"default", "capabilities":{"state":true, "power":false, "health":false, "energy":false, "overheat":false, "control":false, "access":false, "bindings":false, "mount":true, "side":false, "routing":false, "test_override":true}},
	...
	"module_external": {
		"entity_contract":{"scope":"entity", "entity_type":"item", "entity_subtype":"module_external", "status_profile":"item_standard", "property_profile":"fixed", "interaction_profile":"item", "notification_profile":"standard_action", "power_profile":"none", "control_profile":"none", "access_profile":"none", "binding_profile":"none", "runtime_presentation_profile":"standard_item", "editor_presentation_profile":"standard_item", "validation_fixture":"default", "capabilities":{"state":true, "power":false, "health":false, "energy":false, "overheat":false, "control":false, "access":false, "bindings":false, "mount":true, "side":false, "routing":false, "test_override":true}},
	...
	"module_internal": {
		"entity_contract":{"scope":"entity", "entity_type":"item", "entity_subtype":"module_internal", "status_profile":"item_standard", "property_profile":"fixed", "interaction_profile":"item", "notification_profile":"standard_action", "power_profile":"none", "control_profile":"none", "access_profile":"none", "binding_profile":"none", "runtime_presentation_profile":"standard_item", "editor_presentation_profile":"standard_item", "validation_fixture":"default", "capabilities":{"state":true, "power":false, "health":false, "energy":false, "overheat":false, "control":false, "access":false, "bindings":false, "mount":true, "side":false, "routing":false, "test_override":true}},
...
static func get_entity_definition_contract(prefab_id: String) -> Dictionary:
	...
	var raw_contract: Variant = definition.get("entity_contract", {})
	return Dictionary(raw_contract).duplicate(true) if raw_contract is Dictionary else {}
...
const OBJECT_LIBRARY := {
	...
	"external_radiator": {"group":"cooling","name":"External Radiator","placeable_in_constructor":false,"state":"active","cooling_device_type":"radiator","cooling_output":1,"movement_requirement":{"profile_id":"noncrate_heavy_drag","required_actor_types":["engineer","heavy"],"required_manipulator":"heavy_claw","required_manipulator_level":1,"required_power_class":"engineer","movement_mode":"drag"},"material":"metal","blocks_movement":true,"blocks_vision":false,"durability":20},
	"external_air_cooler": {"group":"cooling","object_group":"cooling","object_type":"external_air_cooler","placeable_in_constructor":false,"palette_label":"Air Cooling","name":"External Air Cooler","display_name_template":"Air Cooling","placement_mode":"object","configurable":true,"interactable":true,"state":"off","status":"active","is_powered":false,"power_mode":"external_power","control_mode":"internal_control","cooling_device_type":"air_cooler","cooling_output":2,"directed_airflow":true,"generic_airflow_role":"fan","airflow_roles":["fan","airflow_source"],"fan_enabled":false,"fan_speed":0,"airflow_range":0,"cooling_state":"uncooled","airflow_direction":"sw","facing_side":"SW","facing_dir":"SW","allowed_airflow_directions":["ne","nw","se","sw"],"visual_family":"air_cooling","visual_surface":"floor","visual_state_policy":"powered_three_state","variant_policy":"airflow_direction","visual_variant":"sw","power_visual_state_enabled":true,"movement_requirement":{"profile_id":"noncrate_heavy_drag","required_actor_types":["engineer","heavy"],"required_manipulator":"heavy_claw","required_manipulator_level":1,"required_power_class":"engineer","movement_mode":"drag"},"material":"metal","blocks_movement":true,"blocks_vision":false,"durability":20,"property_schema":[{"field":"airflow_direction","type":"enum","values":["ne","nw","se","sw"],"default":"sw","labels":{"ne":"NE","nw":"NW","se":"SE","sw":"SW"}},{"field":"state","type":"enum","values":["base","off","on"],"default":"off","labels":{"base":"Base","off":"Off","on":"On"}},{"field":"fan_enabled","type":"bool","default":false},{"field":"airflow_range","type":"int","default":0,"min":0}]},
	"metal_cooling_block": {
		"entity_contract":{"scope":"entity", "entity_type":"cooling_system", "entity_subtype":"metal_cooling_block", "status_profile":"cooling_passive", "property_profile":"fixed", "interaction_profile":"cooling", "notification_profile":"none", "power_profile":"none", "control_profile":"none", "access_profile":"none", "binding_profile":"none", "runtime_presentation_profile":"standard_cooling", "editor_presentation_profile":"standard_cooling", "validation_fixture":"default", "capabilities":{"state":false, "power":false, "health":false, "energy":false, "overheat":false, "control":false, "access":false, "bindings":false, "mount":false, "side":false, "routing":false, "test_override":true}},
		"legacy_semantic_exceptions":[{"field":"state", "reason":"Legacy cooling block field pending machines/cooling-box migration.", "migration_issue":1183}, {"field":"durability", "reason":"Legacy cooling block field pending machines/cooling-box migration.", "migration_issue":1183}],
		"group":"cooling","placement_surfaces":["floor"],"default_placement_surface":"floor","requires_floor_anchor_when_wall_mounted":false,"object_group":"cooling","object_type":"metal_cooling_block","placeable_in_constructor":true,"palette_label":"Cooling block","name":"Cooling block","display_name_template":"Cooling block","placement_mode":"object","visual_family":"air_cooling","visual_surface":"floor","visual_asset_id":"air_cooling_base_floor_sw_01","state":"base","material":"metal","cooling_amplifier":true,"movement_requirement":{"profile_id":"noncrate_heavy_drag","required_actor_types":["engineer","heavy"],"required_manipulator":"heavy_claw","required_manipulator_level":1,"required_power_class":"engineer","movement_mode":"drag"},"blocks_movement":true,"blocks_vision":false,"durability":30},
