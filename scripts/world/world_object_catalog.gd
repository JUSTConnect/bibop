...
const ARCHETYPE_REGISTRY: Dictionary = {
	...
	"external_water_pipe": {
		...
		"legacy_semantic_exceptions":[{"field":"state", "reason":"Legacy runtime field pending passive-route migration.", "migration_issue":1191}, {"field":"durability", "reason":"Legacy runtime field pending passive-route migration.", "migration_issue":1191}], "display_name_template":"External Water Pipe", "name":"External Water Pipe", "state":"active", "cooling_device_type":"water_pipe", "cooling_output":2, "passive_cooling":true,
	...
	"power_cable_reel": {
		...
		"legacy_semantic_exceptions":[{"field":"damaged", "reason":"Legacy reel health flag pending runtime reel migration.", "migration_issue":1188}, {"field":"broken", "reason":"Legacy reel health flag pending runtime reel migration.", "migration_issue":1188}],
