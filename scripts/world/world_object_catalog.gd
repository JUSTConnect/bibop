...
const OBJECT_LIBRARY := {
	...
	"platform_terminal": {"group":"terminal","name":"Platform Terminal","terminal_type":"platform","target_platform_id":"","state":"active","power_type":"internal","control_type":"internal","damageable":true,"destructible":false,"platform_control_enabled":true,"platform_remote_control":true,"durability":12},
