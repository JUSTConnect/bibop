...
const OBJECT_LIBRARY := {
	...
	"parts_small": {"group":"item","name":"Parts (Small)","item_form":"physical","storage_type":"pocket","can_place_in_digital_buffer":false,"consumable":false,"fits_targets":[]},
	"parts_medium": {"group":"item","name":"Parts (Medium)","item_form":"physical","storage_type":"pocket","can_place_in_digital_buffer":false,"consumable":false,"fits_targets":[]},
	"parts_large": {"group":"item","name":"Parts (Large)","item_form":"physical","storage_type":"pocket","can_place_in_digital_buffer":false,"consumable":false,"fits_targets":[]},
