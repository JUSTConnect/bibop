...
const OBJECT_LIBRARY := {
	...
	"door_terminal": {"group":"terminal","name":"Door Terminal","placement_mode":"wall_mounted","connection_type":"wired","terminal_class":1,"required_connector_level":1,"required_processor_level":1,"encrypts_data":false,"drain_pool":10,"durability":10,"working_heat":1,"current_heat":1,"overheat_threshold":3,"heat_from_connections":0,"cooling_received":0,"hack_heat":1,"overheated_state_before":""},
	...
	"cooling_terminal": {"group":"terminal","name":"Cooling Terminal","placement_mode":"wall_mounted","connection_type":"wired","terminal_class":1,"required_connector_level":1,"required_processor_level":1,"encrypts_data":false,"drain_pool":10,"durability":10,"working_heat":1,"current_heat":1,"overheat_threshold":3,"heat_from_connections":0,"cooling_received":0,"hack_heat":1,"overheated_state_before":""},
	...
	"power_cable": {"group":"power","name":"Power Cable","state":"ok","durability":5,"power_mode":"external_power","is_powered":false,"is_hidden":false,"route_surface":"floor","power_source_id":"","physical_connection_source_id":""},
	"circuit_breaker": {"group":"power","name":"Circuit Breaker","placement_mode":"wall_mounted","state":"switch_on","is_on":true,"durability":8,"power_source_id":""},
	"circuit_switch": {"group":"power","name":"Circuit Switch","state":"switch_off","durability":8,"power_source_id":"","input_wire_id":"","output_1_wire_id":"","output_2_wire_id":"","output_3_wire_id":"","active_output_index":1},
	"fuse_box": {"group":"power","name":"Fuse Box","placement_mode":"wall_mounted","state":"installed","durability":8,"requires_fuse":true,"fuse_installed":true,"power_source_id":""},
	"fuse_box_installed": {"group":"power","name":"Fuse Box Installed","state":"installed","durability":8,"requires_fuse":true,"fuse_installed":true,"power_source_id":""},
	"fuse_box_empty": {"group":"power","name":"Fuse Box Empty","state":"empty","durability":8,"requires_fuse":true,"fuse_installed":false,"power_source_id":""},
