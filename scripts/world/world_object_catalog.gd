...
const OBJECT_LIBRARY := {
	...
	"circuit_breaker": {"group":"power","name":"Circuit Breaker","placement_mode":"wall_mounted","state":"switch_on","durability":8},
	"circuit_switch": {"group":"power","name":"Circuit Switch","state":"switch_off","durability":8},
	"fuse_box": {"group":"power","name":"Fuse Box","placement_mode":"wall_mounted","state":"installed","durability":8,"requires_fuse":true},
	...
	"light_switch": {"group":"power","name":"Light Switch","placement_mode":"wall_mounted","state":"switch_off","durability":6,"can_be_switched":true},
	"power_socket": {"group":"power","name":"Power Socket","state":"disconnected","durability":8,"can_connect_cable":true},
	"power_cable_reel": {"group":"item","name":"Power Cable Reel","placement_mode":"wall_mounted","state":"disconnected","item_form":"physical","storage_type":"pocket","can_connect_socket":true,"max_cable_length":5},
