...
const OBJECT_LIBRARY := {
	...
	"turret_terminal": {"group":"terminal","name":"Turret Terminal","connection_type":"wireless","terminal_class":3,"required_interface_level":3,"required_cpu_level":3,"encrypts_data":true,"drain_pool":30,"durability":10},
	...
	"fuse_box": {"group":"power","name":"Fuse Box","state":"empty","durability":8,"requires_fuse":true},
	"light": {"group":"power","name":"Light","state":"active","durability":6},
	"light_switch": {"group":"power","name":"Light Switch","state":"switch_off","durability":6},
	"power_socket": {"group":"power","name":"Power Socket","state":"connected","durability":8},
	"power_cable_reel": {"group":"power","name":"Power Cable Reel","state":"disconnected","durability":10},
	"power_source": {"group":"power","name":"Power Source","state":"active","durability":30,"power_source_class":1,"drain_pool":60},
	"energy_door_power_object": {"group":"power","name":"Energy Door Power Object","state":"active","durability":10},
	"module_external": {"group":"item","name":"Module External","item_storage":"pocket"},"module_internal": {"group":"item","name":"Module Internal","item_storage":"pocket"},"mechanical_keycard": {"group":"item","name":"Mechanical KeyCard","item_storage":"pocket","key_kind":"mechanical"},"fuse": {"group":"item","name":"Fuse","item_storage":"manipulator_hold","consumable":true},"repair_kit": {"group":"item","name":"Repair Kit","item_storage":"manipulator_hold","consumable":true},"reinforcement": {"group":"item","name":"Reinforcement","item_storage":"manipulator_hold","consumable":true,"damage":2},"parts": {"group":"item","name":"Parts","item_storage":"pocket"},"sample": {"group":"item","name":"Sample","item_storage":"pocket"},"mission_item": {"group":"item","name":"Mission Item","item_storage":"pocket"},"digital_key_opened": {"group":"item","name":"Digital Key Opened","item_storage":"digital_buffer","digital_state":"opened"},"digital_key_encrypted": {"group":"item","name":"Digital Key Encrypted","item_storage":"digital_buffer","digital_state":"encrypted"},"digital_key_damaged": {"group":"item","name":"Digital Key Damaged","item_storage":"digital_buffer","digital_state":"damaged"},"access_code": {"group":"item","name":"Access Code","item_storage":"digital_storage"},"data_file_opened": {"group":"item","name":"Data File Opened","item_storage":"digital_buffer","digital_state":"opened"},"data_file_encrypted": {"group":"item","name":"Data File Encrypted","item_storage":"digital_buffer","digital_state":"encrypted"},"data_file_damaged": {"group":"item","name":"Data File Damaged","item_storage":"digital_buffer","digital_state":"damaged"},
	"normal_crate": {"group":"physical_object","name":"Normal Crate","weight_class":"normal","required_bipob_power_class":"scout","durability":8,"blocks_movement":true},"heavy_crate": {"group":"physical_object","name":"Heavy Crate","weight_class":"heavy","required_bipob_power_class":"engineer","durability":14,"blocks_movement":true},"movable_platform_block": {"group":"physical_object","name":"Movable Platform Block","weight_class":"block","required_bipob_power_class":"juggernaut","durability":20,"blocks_movement":true},"disabled_bipop_scout": {"group":"physical_object","name":"Disabled Bipop Scout","weight_class":"normal","required_bipob_power_class":"scout","durability":10},"disabled_bipop_engineer": {"group":"physical_object","name":"Disabled Bipop Engineer","weight_class":"heavy","required_bipob_power_class":"engineer","durability":15},"disabled_bipop_juggernaut": {"group":"physical_object","name":"Disabled Bipop Juggernaut","weight_class":"block","required_bipob_power_class":"juggernaut","durability":25},"barrel": {"group":"physical_object","name":"Barrel","weight_class":"normal","required_bipob_power_class":"scout","durability":8},"explosive_barrel": {"group":"physical_object","name":"Explosive Barrel","weight_class":"normal","required_bipob_power_class":"scout","durability":6,"on_destroy":"explode"},"debris": {"group":"physical_object","name":"Debris","weight_class":"normal","required_bipob_power_class":"scout","durability":1,"blocks_movement":false,"terrain_tag":"debris","movement_debuff":-1},
	"enemy_robot": {"group":"threat","name":"Enemy Robot","state":"active","durability":20,"behavior_state":"patrolling"},"turret": {"group":"threat","name":"Turret","state":"active","durability":15,"behavior_state":"idle"},"bug": {"group":"threat","name":"Bug","state":"active","durability":6,"behavior_state":"patrolling"},"vagus": {"group":"threat","name":"Vagus","state":"active","durability":30,"behavior_state":"alert"}
}
