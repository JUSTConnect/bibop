...
@export var sensor_direction: String = ""
@export var visibility_value: int = 0
...
@export var span_text: String = ""
@export var fuel_capacity: int = 0
@export var ammo_dependency_id: String = ""
...
@export var sensor_range_bonus: int = 0
@export var sensor_visibility_bonus: int = 0
